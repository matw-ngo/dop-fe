...
const FinancialNeedsAssessment: React.FC<FinancialNeedsAssessmentProps> = ({
  form,
  language,
}) => {
  const {
  ...
  const debtToIncomeRatio = watchedValues.financial?.existingMonthlyDebtPayments
    ? (watchedValues.financial.existingMonthlyDebtPayments / monthlyIncome) *
      100
    : 0;
  ...
  const totalNewMonthlyDebt =
    (watchedValues.financial?.existingMonthlyDebtPayments || 0) +
    estimatedMonthlyPayment;
  const totalDebtToIncomeRatio =
    monthlyIncome > 0 ? (totalNewMonthlyDebt / monthlyIncome) * 100 : 0;
  ...
  const translations = {
    vi: {
      ...
      warnings: {
        highDebtRatio:
          "Tỷ lệ nợ/thu nhập cao (>50%), có thể ảnh hưởng đến khả năng được duyệt vay",
        veryHighDebtRatio:
          "Tỷ lệ nợ/thu nhập rất cao (>70%), khó được duyệt vay",
        incomeVerification:
          "Bạn cần có giấy tờ chứng minh thu nhập để tăng khả năng được duyệt",
      },
    },
    en: {
      employment: {
      ...
      warnings: {
        highDebtRatio:
          "High debt-to-income ratio (>50%), may affect loan approval",
        veryHighDebtRatio:
          "Very high debt-to-income ratio (>70%), loan approval unlikely",
        incomeVerification:
          "Income verification documents required to improve approval chances",
      },
    },
  };
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>
              {t.calculations.debtToIncome} &{" "}
              {t.calculations.estimatedMonthlyPayment}
            </span>
          </CardTitle>
        </CardHeader>
            ...
            <div>
              ...
              <div className="text-2xl font-bold text-green-600">
                {new Intl.NumberFormat("vi-VN", {
                  style: "currency",
                  currency: "VND",
                }).format(estimatedMonthlyPayment)}
              </div>
            </div>
          </div>
          <div>
            <Label className="text-sm font-medium">
              {t.calculations.totalDebtToIncome}
            </Label>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  setValue("employment.employmentType", value)
                }
                defaultValue={watchedValues.employment?.employmentType}
              >
                <SelectTrigger
                  className={
                    (errors.employment as any)?.employmentType
                      ? "border-red-500"
                      : ""
                  }
                >
              ...
              {(errors.employment as any)?.employmentType && (
                <p className="text-sm text-red-600">
                  {(errors.employment as any).employmentType.message as string}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger
                  className={
                    (errors.employment as any)?.employmentStatus
                      ? "border-red-500"
                      : ""
                  }
                >
            ...
            <div className="space-y-2">
              <Label>
                {t.employment.workDuration} ({t.employment.months})
              </Label>
              <Input
                type="number"
                {...register("employment.workDurationMonths", {
                  valueAsNumber: true,
                })}
                className={
                  (errors.employment as any)?.workDurationMonths
                    ? "border-red-500"
                    : ""
                }
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label>
                {t.employment.monthlyIncome} ({t.calculations.currency})
              </Label>
              <div className="space-y-2">
                <Slider
                  value={[monthlyIncome]}
                ...
                <Input
                  ...
                  className={
                    (errors.employment as any)?.monthlyIncome
                      ? "border-red-500"
                      : ""
                  }
                />
              ...
              {(errors.employment as any)?.monthlyIncome && (
                <p className="text-sm text-red-600">
                  {(errors.employment as any).monthlyIncome.message as string}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  setValue("employment.incomeSource", value)
                }
                defaultValue={watchedValues.employment?.incomeSource}
              >
                <SelectTrigger
                  className={
                    (errors.employment as any)?.incomeSource
                      ? "border-red-500"
                      : ""
                  }
                >
              ...
              {(errors.employment as any)?.incomeSource && (
                <p className="text-sm text-red-600">
                  {(errors.employment as any).incomeSource.message as string}
                </p>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setValue("employment.canProvideIncomeProof", checked)
              }
            />
            <Label htmlFor="canProvideIncomeProof">
              {t.employment.canProvideProof}
            </Label>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label>
                {t.financial.existingDebt} ({t.calculations.currency})
              </Label>
              <Input
                type="number"
                {...register("financial.existingMonthlyDebtPayments", {
                  valueAsNumber: true,
                })}
                className={
                  (errors.financial as any)?.existingMonthlyDebtPayments
                    ? "border-red-500"
                    : ""
                }
              />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setValue("financial.hasBankAccount", checked)
              }
            />
          ...
          <div className="space-y-3">
            <Label className="text-sm font-medium">
              {t.financial.hasAssets as string}
            </Label>
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setValue("financial.assets.hasRealEstate", checked)
                  }
                />
                <Label htmlFor="hasRealEstate">
                  {t.financial.hasAssets.realEstate}
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setValue("financial.assets.hasVehicle", checked)
                  }
                />
                <Label htmlFor="hasVehicle">
                  {t.financial.hasAssets.vehicle}
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setValue("financial.assets.hasSavings", checked)
                  }
                />
                <Label htmlFor="hasSavings">
                  {t.financial.hasAssets.savings}
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setValue("financial.assets.hasInvestments", checked)
                  }
                />
                <Label htmlFor="hasInvestments">
                  {t.financial.hasAssets.investments}
                </Label>
              </div>
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label>
                {t.loan.requestedAmount} ({t.calculations.currency})
              </Label>
              <div className="space-y-2">
                <Slider
                  value={[loanAmount]}
                ...
                <Input
                  ...
                  className={
                    (errors.loanRequirements as any)?.requestedAmount
                      ? "border-red-500"
                      : ""
                  }
                />
            ...
            <div className="space-y-2">
              <Label>
                {t.loan.loanTerm} ({t.employment.months})
              </Label>
              <div className="space-y-2">
                <Slider
                  value={[loanTerm]}
                ...
                <Input
                  ...
                  className={
                    (errors.loanRequirements as any)?.requestedTerm
                      ? "border-red-500"
                      : ""
                  }
                />
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  setValue("loanRequirements.loanType", value)
                }
                defaultValue={watchedValues.loanRequirements?.loanType}
              >
                <SelectTrigger
                  className={
                    (errors.loanRequirements as any)?.loanType
                      ? "border-red-500"
                      : ""
                  }
                >
              ...
              {(errors.loanRequirements as any)?.loanType && (
                <p className="text-sm text-red-600">
                  {(errors.loanRequirements as any).loanType.message as string}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  setValue("loanRequirements.urgency", value)
                }
                defaultValue={watchedValues.loanRequirements?.urgency}
              >
                <SelectTrigger
                  className={
                    (errors.loanRequirements as any)?.urgency
                      ? "border-red-500"
                      : ""
                  }
                >
              ...
              {(errors.loanRequirements as any)?.urgency && (
                <p className="text-sm text-red-600">
                  {(errors.loanRequirements as any).urgency.message as string}
                </p>
              )}
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={
                (errors.loanRequirements as any)?.loanPurpose
                  ? "border-red-500"
                  : ""
              }
            />
            {(errors.loanRequirements as any)?.loanPurpose && (
              <p className="text-sm text-red-600">
                {(errors.loanRequirements as any).loanPurpose.message as string}
              </p>
            )}
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setValue("loanRequirements.collateralAvailable", checked)
                }
              />
            ...
            {watchedValues.loanRequirements?.collateralAvailable && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-6">
                ...
                <div className="space-y-2">
                  <Label>
                    {t.loan.collateralValue} ({t.calculations.currency})
                  </Label>
                  <Input
                    type="number"
                    placeholder={t.loan.collateralValue}
                    {...register("loanRequirements.collateralValue", {
                      valueAsNumber: true,
                    })}
                  />
                </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              step="0.1"
              placeholder="20.0"
              {...register("loanRequirements.preferredInterestRate", {
                valueAsNumber: true,
              })}
              min={0}
              max={50}

...
/**
 * Simplified TextField component that handles most styling directly
 * Uses theme only for truly customizable properties
 */
export function TextFieldSimplified({
  field,
  value,
  onChange,
  onBlur,
...
TextFieldSimplified.displayName = "TextFieldSimplified";

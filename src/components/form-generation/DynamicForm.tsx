...
export function DynamicForm({
    ...
    const handleSubmit = useCallback(
        ...
        [formData, fieldValidationRules, customOnSubmit, config.onSubmit, isSubmitting, disabled, readOnly]
    );
    ...
    const renderField = useCallback(
        ...
        [formData, errors, touched, isFieldVisible, isFieldDisabled, handleFieldChange, handleFieldBlur, config.i18n, readOnly]
    );
                ...
                <div className="space-y-6">
                    {config.sections.map((section) => (
                        <FormSection
                            ...
                            section={section}
                            formValues={formData}
                            variant={section.className?.includes('border') ? 'bordered' : 'default'}
                        >

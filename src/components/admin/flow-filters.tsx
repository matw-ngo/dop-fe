...
export function FlowFilters({
  ...
  const statusOptions: { value: FlowStatus; label: string; color: string }[] = [
    { value: "active", label: t("statusOptions.active"), color: "bg-green-100 text-green-800" },
    { value: "inactive", label: t("statusOptions.inactive"), color: "bg-gray-100 text-gray-800" },
    { value: "draft", label: t("statusOptions.draft"), color: "bg-yellow-100 text-yellow-800" },
    { value: "archived", label: t("statusOptions.archived"), color: "bg-red-100 text-red-800" },
  ];
  ...
  const handleStatusToggle = useCallback((status: FlowStatus) => {
  ...
  const hasActiveFilters = useMemo(() => searchValue || statusFilters.length > 0, [searchValue, statusFilters.length]);

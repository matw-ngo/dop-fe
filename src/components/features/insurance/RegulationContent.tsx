    ...
    items: [
      {
        ...
        summary: "Luật sửa đổi, bổ sung một số điều của Luật Kinh doanh bảo hiểm số 08/2022/QH15",
      ...
      },
      {
        ...
        documents: [
          { name: "Nghị định 46/2023/NĐ-CP", type: "PDF", url: "#" }
        ]
      }
    ]
  },
    ...
    items: [
      {
        ...
        summary: "Quy định về mức phí, mức trách nhiệm bảo hiểm bắt buộc TNDS xe cơ giới",
      ...
      },
      {
        ...
        documents: [
          { name: "Nghị định 03/2021/NĐ-CP", type: "PDF", url: "#" }
        ]
      }
    ]
  },
    ...
    items: [
      {
        ...
        summary: "Thủ tục và quy trình giải quyết bồi thường khi xảy ra tai nạn",
          ...
          process: [
            {
              ...
              description: "Thông báo ngay cho công ty bảo hiểm và cơ quan chức năng",
            ...
            },
            {
              ...
              documents: ["Giấy chứng nhận bảo hiểm", "Giấy đăng ký xe", "Giấy phép lái xe"]
            },
            {
              step: 3,
    ...
    items: [
      {
        ...
        summary: "Quy định xử phạt vi phạm hành chính trong lĩnh vực giao thông đường bộ và đường sắt",
        ...
        content: {
          violations: [
            {
              description: "Người điều khiển xe không có giấy chứng nhận bảo hiểm TNDS bắt buộc xe cơ giới",
              penalty: "Phạt tiền từ 400.000 VNĐ đến 600.000 VNĐ",
              additional: "Tịch thu phương tiện trong 7 ngày nếu không có bảo hiểm"
            },
            {
            ...
            {
              description: "Doanh nghiệp bảo hiểm vi phạm quy định về kinh doanh",
...
export default function RegulationContent() {
  ...
  const [expandedCategories, setExpandedCategories] = useState<string[]>(["basic", "compulsory"]);
  ...
  const handleDownload = (documentName: string) => {
    toast.success(t("regulations.download.started", { document: documentName }));
  };

  const filteredRegulations = Object.entries(regulationsData).map(([key, category]) => {
                ...
                <CollapsibleContent>
                  <CardContent className="space-y-4">
                    {category.items.map((item) => {
                      ...
                      const statusColor = item.status === "hiệu lực" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800";
                          ...
                          <CollapsibleContent>
                            <div className="px-4 pb-4">
                              ...
                              {item.content.highlights && (
                                <div className="mb-6">
                                  ...
                                  <ul className="space-y-2">
                                    {item.content.highlights.map((highlight: string, index: number) => (
                              ...
                              {item.content.feeTable && (
                                <div className="mb-6">
                                  <h4 className="font-semibold text-base mb-3">{t("regulations.feeTable")}</h4>
                                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                    <div>
                                      <h5 className="font-medium text-sm mb-2">Ô tô</h5>
                                      <Table>
                                        <TableHeader>
                                          <TableRow>
                                            <TableHead className="w-[60%]">Loại xe</TableHead>
                                            <TableHead>Phí</TableHead>
                                          </TableRow>
                                        </TableHeader>
                                        <TableBody>
                                          {item.content.feeTable.cars.map((fee: any, index: number) => (
                                            <TableRow key={index}>
                                              <TableCell className="text-sm">{fee.type}</TableCell>
                                              <TableCell className="text-sm font-medium">{fee.fee}</TableCell>
                                            </TableRow>
                                          ))}
                                        </TableBody>
                                      </Table>
                                    ...
                                    <div>
                                      <h5 className="font-medium text-sm mb-2">Xe máy</h5>
                                      <Table>
                                        <TableHeader>
                                          <TableRow>
                                            <TableHead className="w-[60%]">Loại xe</TableHead>
                                        ...
                                        <TableBody>
                                          {item.content.feeTable.motorcycles.map((fee: any, index: number) => (
                                            <TableRow key={index}>
                                              <TableCell className="text-sm">{fee.type}</TableCell>
                                              <TableCell className="text-sm font-medium">{fee.fee}</TableCell>
                                            </TableRow>
                              ...
                              {item.content.process && (
                                <div className="mb-6">
                                  ...
                                  <div className="space-y-4">
                                    {item.content.process.map((step: any, index: number) => (
                              ...
                              {item.content.violations && (
                                <div className="mb-6">
                                  <h4 className="font-semibold text-base mb-3">{t("regulations.violations")}</h4>
                                  <div className="space-y-3">
                                    {item.content.violations.map((violation: any, index: number) => (

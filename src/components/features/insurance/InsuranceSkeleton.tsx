...
const InsuranceSkeleton: React.FC<InsuranceSkeletonProps> = ({
  viewMode = "grid",
  ...
  if (viewMode === "compact") {
    return (
      <div
        ...
        role="status"
        aria-live="polite"
        aria-label="Đang tải danh sách bảo hiểm"
        aria-busy="true"
      >
        ...
        {Array.from({ length: count }, (_, i) => (
          ...
          >
            ...
            <CardFooter className="pt-0">
              <div className="h-10 w-full bg-gray-200 rounded flex items-center justify-center">

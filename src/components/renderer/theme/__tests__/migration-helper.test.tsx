...
describe("Migration Helper", () => {
  ...
  describe("ThemeMigrationHelper", () => {
    ...
    it("should have createComponentReplacementMap method", () => {
      ...
      expect(typeof ThemeMigrationHelper.createComponentReplacementMap).toBe(
        "function",
      );
    });
    ...
    it("should create component replacement map", () => {
      const replacementMap =
        ThemeMigrationHelper.createComponentReplacementMap();
      ...
      const TestComponent = () => {
        ...
        return (
          <div data-testid="theme-values">
            <span data-testid="is-dark">
              {legacyTheme.isDark ? "true" : "false"}
            </span>
            <span data-testid="resolved-theme">
              {legacyTheme.resolvedTheme || "light"}
            </span>
          </div>
        );
      };

...
>((props, ref) => {
  ...
  const textColor = contextTheme.colors.textPrimary || "#3F4350";
  ...
  const selectContentStyles = {
    borderColor: contextTheme.colors.border,
    backgroundColor: contextTheme.colors.background,
    color: textColor,
    "--color-popover": contextTheme.colors.background,
    "--color-popover-foreground": textColor,
    "--color-accent": contextTheme.colors.readOnly,
    "--color-accent-foreground": textColor,
    "--color-primary": primaryColor,
    "--color-ring": contextTheme.colors.borderFocus || primaryColor,
    "--select-item-hover": contextTheme.colors.readOnly,
    "--select-item-text": textColor,
    "--select-item-placeholder": placeholderColor,
  } as React.CSSProperties;
        ...
        <SelectPrimitive.Portal>
          <SelectPrimitive.Content
            className={cn(
              ...
              "border rounded-lg shadow-[0px_8px_24px_0px_#0000001F]",
              ...
              {props.options.map((option) => (
                <SelectPrimitive.Item
                  ...
                  className={cn(
                    ...
                    "hover:bg-[var(--select-item-hover)]",
                    "focus:bg-[var(--select-item-hover)]",
                    "data-[state=checked]:bg-[var(--select-item-hover)]",
                    "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
                    "data-[state=checked]:font-bold data-[state=unchecked]:font-normal",
                  )}
                  style={{ color: "var(--select-item-text)" }}
                >
